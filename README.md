...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `14.4µs` | `25.5µs` |
| [Day 2](./src/bin/02.rs) | `7.3ms` | `61.7ms` |
| [Day 3](./src/bin/03.rs) | `21.5µs` | `73.3ms` |
| [Day 4](./src/bin/04.rs) | `234.5µs` | `4.8ms` |
| [Day 5](./src/bin/05.rs) | `199.1µs` | `47.8µs` |
| [Day 6](./src/bin/06.rs) | `81.0µs` | `81.8µs` |
| [Day 7](./src/bin/07.rs) | `110.6µs` | `378.6µs` |
| [Day 8](./src/bin/08.rs) | `69.0ms` | `72.0ms` |
| [Day 11](./src/bin/11.rs) | `124.0µs` | `2.2ms` |
| [Day 12](./src/bin/12.rs) | `468.5ms` | `-` |
